...
I read a total of `r sum(data$Pages)` pages this year.\
...
The author I read most from this year was `r authors[which(authors$n == max((authors[which(authors$n != 1),2]))),1]`. I read a total a total of `r max((authors[which(authors$n != 1),2]))` of their books.\
Click this `r colorize("link", "#0000EE")` **?????** to read more about that author.
